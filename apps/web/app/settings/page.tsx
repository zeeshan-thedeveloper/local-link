      ...
      <div className="settings-grid">
        <div className="section">
          ...
          <div style={{ padding: 22, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div className="field" style={{ margin: 0 }}>
              ...
              <input className="input" value={email} readOnly style={{ color: "var(--text-2)" }}/>
              <div className="field-help">Account email cannot be changed.</div>
            </div>
            <div className="field" style={{ margin: 0 }}>
              <div className="field-label">Display name</div>
              <input className="input" defaultValue={displayName}/>
            </div>
          </div>
        </div>
        ...
        <div className="section">
          <div className="section-head">
            <div><h3 className="section-title">Host application</h3><p className="section-sub">Connect this machine to tunnel local resources.</p></div>
          ...
          <div style={{ padding: 22 }}>
            ...
            <div className="callout">
              ...
              <div>No host is connected yet. Once the host app connects, resource tunnels and request logs will appear.</div>
            </div>
          </div>
        </div>
      </div>
