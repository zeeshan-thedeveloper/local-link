        ...
        <div className="login-window-body">
          <aside className="login-aside">
            ...
            <div className="login-term">
              ...
              <div className="ln pad">
                ...
                <span className="info">agent online</span>
                <span className="com">// v0.4.2</span>
              </div>
              <div className="ln pad">
                <span className="ok">✓</span>
                <span className="info">tunnel reachable</span>
              ...
              <div className="ln">
                <span className="prompt">$</span>
                <span className="cmd">locallink whoami</span>
              </div>
              <div className="ln pad">
                <span className="arrow">→</span>
                <span className="info">authenticate to continue</span>
              </div>
              <div className="ln">
                <span className="prompt">$</span>
            ...
            <div className="login-stats">
              <div className="login-stat">
                ...
                <span className="v">single-user</span>
              </div>
              <div className="login-stat">
                <span className="k">// region</span>
                <span className="v">self-hosted</span>
              </div>
              <div className="login-stat">
                <span className="k">// build</span>
                <span className="v">8h2j4a</span>
              </div>
              <div className="login-stat">
          ...
          <section className="login-form-pane">
            ...
            <a
              ...
              className="btn btn-secondary login-oauth-secondary"
              style={{ width: "100%", height: 38, justifyContent: "center" }}
            >
