      ...
      <div className="l-nav-wrap">
        <nav className="l-nav">
          ...
          <div className="l-nav-links">
            <a className="l-nav-link" href="#features">
              Features
            </a>
            <a className="l-nav-link" href="#quickstart">
              Quickstart
            </a>
            <a className="l-nav-link" href="https://github.com">
              Docs
            </a>
            <a className="l-nav-link" href="https://github.com">
              Changelog
          ...
          <div className="l-nav-cta">
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.4 0 0 5.4 0 12c0 5.3 3.4 9.8 8.2 11.4.6.1.8-.3.8-.6v-2.1c-3.3.7-4-1.6-4-1.6-.6-1.4-1.4-1.8-1.4-1.8-1.1-.7.1-.7.1-.7 1.2.1 1.9 1.3 1.9 1.3 1.1 1.9 2.9 1.3 3.6 1 .1-.8.4-1.3.8-1.6-2.7-.3-5.5-1.3-5.5-6 0-1.3.5-2.4 1.3-3.2-.1-.3-.6-1.6.1-3.2 0 0 1-.3 3.3 1.2 1-.3 2-.4 3-.4s2 .1 3 .4c2.3-1.5 3.3-1.2 3.3-1.2.7 1.6.2 2.9.1 3.2.8.8 1.3 1.9 1.3 3.2 0 4.6-2.8 5.7-5.5 6 .4.4.8 1.1.8 2.2v3.3c0 .3.2.7.8.6C20.6 21.8 24 17.3 24 12c0-6.6-5.4-12-12-12z" />
              </svg>
              <span>GitHub</span>
            </a>
        ...
        <div className="l-container">
          <section className="l-hero">
            <div className="l-eyebrow">
              ...
              v0.4.2 <span className="sep">·</span> self-hosted <span className="sep">·</span>{" "}
              single-user <span className="sep">·</span> MIT
            </div>
            ...
            <p className="l-hero-sub">
              A self-hosted gateway that exposes local Postgres databases and HTTP APIs through a
              secure tunnel, with resource-scoped keys and per-request logs.
            </p>
            ...
            <div className="l-window">
              ...
              <div className="l-preview-body">
                ...
                <div className="l-preview-left">
                  ...
                  <div className="l-term">
                    <div className="ln">
                      ...
                      <span className="cmd">locallink up</span>
                    </div>
                    <div className="ln pad">
                      <span className="arrow">→</span>
                      <span className="info">connecting to</span>
                      <span className="str">gateway.kestrel.io</span>
                      <span className="arrow">…</span>
                    </div>
                    <div className="ln pad">
                      <span className="ok">✓</span>
                      <span className="info">tunnel established</span>
                      <span className="com">// WSS, AES-256-GCM</span>
                    </div>
                    <div className="ln">
                      <span className="prompt">$</span>
                      <span className="cmd">locallink expose</span>
                      <span className="str">postgres-main</span>
                      <span className="flag">--port</span>
                      <span className="str">5432</span>
                    </div>
                    <div className="ln pad">
                      <span className="ok">✓</span>
                      <span className="info">registered</span>
                      <span className="str">postgres-main</span>
                      <span className="com">// 2 keys</span>
                    </div>
                    <div className="ln">
                      <span className="prompt">$</span>
                      <span className="cmd">locallink expose</span>
                      <span className="str">internal-api</span>
                      <span className="flag">--url</span>
                    ...
                    <div className="ln pad">
                      ...
                      <span className="info">registered</span>
                      <span className="str">internal-api</span>
                      <span className="com">// 1 key</span>
                    </div>
                    <div className="ln">
                      <span className="prompt">$</span>
                      <span className="cmd">locallink status</span>
                    </div>
                    <div className="ln pad">
                      <span className="info">2 resources</span>
                      <span className="arrow">·</span>
                      <span className="info">3 keys</span>
                      <span className="arrow">·</span>
                ...
                <div className="l-preview-right">
                  <p className="l-preview-label">
                    ...
                    <span className="badge" id="l-live-count">
                      last 6 · auto
                    </span>
                  </p>
                  <div className="l-live-list" id="l-live-list">
                    ...
                    <div className="l-live-row">
                      ...
                      <span className="m method-POST">POST</span>
                      <span className="p">/r/internal-api/jobs</span>
                      <span className="r">ll_pk_8h2j</span>
                      <span className="s sc-2xx">200</span>
                    </div>
                    <div className="l-live-row">
                      ...
                      <span className="p">/r/internal-api/health</span>
                      <span className="r">ll_pk_8h2j</span>
                      <span className="s sc-2xx">200</span>
                    </div>
                    <div className="l-live-row">
                      ...
                      <span className="m method-POST">POST</span>
                      <span className="p">/r/admin-api/users</span>
              ...
              <div className="l-preview-foot">
                <span className="stat">
                  ...
                  <span className="v">tunnel live</span>
                </span>
                <span className="stat">
                  <span className="k">requests/24h</span>
                  <span className="v">12,163</span>
                </span>
                <span className="stat">
                  <span className="k">p50 latency</span>
                  <span className="v">28ms</span>
                </span>
                <span className="stat">
                ...
                <span className="stat" style={{ marginLeft: "auto" }}>
                  ...
                  <span className="v">gateway.kestrel.io</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="l-container">
          <div className="l-section-head">
            ...
            <p className="l-section-sub">
              Ngrok gives you a URL. LocalLink gives you a URL plus the access control and
              observability you'd build around it anyway.
            </p>
          </div>
          ...
          <div className="l-feat-grid">
            ...
            <div className="l-feat">
              ...
              <p>
                Host agent opens an outbound encrypted WebSocket to your gateway. No port
                forwarding, no firewall changes, no public IP needed.
              </p>
            ...
            <div className="l-feat">
              ...
              <p>
                Register a Postgres connection string or HTTP service by name. Gateway URLs stay
                stable across host restarts.
              </p>
              <div className="l-feat-art">
                <div className="l-art-resources">
                  <div className="l-art-res">
                    <span className="glyph db">
                      <svg
                        width="11"
                        height="11"
                        viewBox="0 0 24 24"
                  ...
                  <div className="l-art-res">
                    ...
                    <span className="name">admin-api</span>
                    <span className="type">http</span>
            ...
            <div className="l-feat">
              <div className="l-feat-head">
                <div className="l-feat-icon">
                  ...
                  >
                    ...
                    <path d="m10 13 8-8M16 3l4 4-2 2-4-4M14 7l3 3" />
                  </svg>
                </div>
              ...
              <p>
                Issue keys scoped to specific resources. Rotate or revoke them from the dashboard
                when access changes.
              </p>
              <div className="l-feat-art">
                <div className="l-art-key">
                  ...
                  <span className="scope">pgmain</span>
                </div>
            ...
            <div className="l-feat">
              ...
              <p>
                Every proxied request recorded: timestamp, method, path, status, latency, key.
                Filter, tail, export to your logging stack.
              </p>
              <div className="l-feat-art">
                <div className="l-art-logs">
                  <div className="l-art-log">
                    <span className="t">32:18</span>
                    <span className="m method-POST">POST</span>
                    <span className="p">/r/pgmain/query</span>
                    <span className="d sc-2xx">42ms</span>
                  </div>
                  <div className="l-art-log">
                    <span className="t">32:17</span>
                    <span className="m method-POST">POST</span>
                    <span className="p">/r/internal-api/jobs</span>
                    <span className="d sc-2xx">184ms</span>
                  </div>
                  <div className="l-art-log">
                    <span className="t">32:13</span>
                    <span className="m method-POST">POST</span>
                    <span className="p">/r/pgmain/query</span>
                    <span className="d sc-4xx">401</span>
                  </div>
                  <div className="l-art-log">
                    <span className="t">32:07</span>
                    <span className="m method-POST">POST</span>
                    <span className="p">/r/admin-api/import</span>
                    <span className="d sc-5xx">500</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="l-section" id="quickstart" style={{ paddingTop: 0 }}>
        <div className="l-container">
          <div className="l-section-head">
            ...
            <p className="l-section-sub">
              Three commands. The gateway runs on a $5 VPS (or your homelab); the agent runs on your
              laptop.
            </p>
          </div>
          ...
          <div className="l-quick-grid">
            <div className="l-quick">
              ...
              <p className="l-quick-note">
                Installs <span className="mono">locallink</span> to{" "}
                <span className="mono">/usr/local/bin</span>.
              </p>
            </div>

            <div className="l-quick">
              <div className="l-quick-step">
                <span className="num">02.</span>Open the tunnel
              </div>
            ...
            <div className="l-quick">
              <div className="l-quick-step">
                <span className="num">03.</span>Expose a resource
              </div>
              ...
              <p className="l-quick-note">
                Reachable at <span className="mono">/r/postgres-dev</span> with an auto-generated
                key.
              </p>
            </div>
          </div>
          ...
          <div className="l-callout">
            <div className="l-callout-text">
              ...
              <p>
                Open the gateway dashboard to manage resources, rotate keys, and tail the request
                log.
              </p>
            </div>
      ...
      <footer className="l-foot">
        <div className="l-foot-inner">
          <div className="l-foot-brand">
            <span className="brand-mark"></span>LocalLink
          </div>
          <span className="sep">·</span>
